...
"""
#==============================================================================
# Algo avec régression, PAS de partition selon ASS_ASSIGNMENT
#==============================================================================
...
#   Enlever les ass_assignment non traités    
    print "Removing non-treated ASS_ASSIGNMENT"
...
#Concaténer météo et groups
    print "Concatenating meteo and groups"
...
#  partitionner les données selon leur ass_assignment
    print "New ass_assignment columns"
    ass_list = np.unique(groups['ASS_ASSIGNMENT'].values)
...
#    OU BIEN : on crée plusieurs colonnes
    for ass in ass_list :
        print "creating column : AA_"+ass
        groups["AA_"+ass] = (groups['ASS_ASSIGNMENT'] == ass)*1
        
    labels = groups['CSPL_RECEIVED_CALLS']
    groups.drop(['ASS_ASSIGNMENT','CSPL_RECEIVED_CALLS'], axis=1, inplace = True)
    
    
#%%
    
    
    return groups, labels, meteo